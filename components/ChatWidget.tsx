...
export default function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      <div className="w-80 sm:w-96 h-[450px] bg-white border border-gray-200 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        <div className="bg-gradient-to-r from-orange-500 to-amber-500 p-4 text-white font-bold flex justify-between items-center">
          <div>
            BiteFinder AI Engine
            <span className="block text-[10px] font-normal text-orange-100">RAG Context Enabled</span>
          </div>
          <button onClick={() => setIsOpen(false)} className="text-white hover:text-gray-200 text-sm font-bold cursor-pointer">✕</button>
        </div>
